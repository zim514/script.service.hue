...
### Colour Filters:
As the system is based on colour of the current frame, predominantly white and black frames can produce harsh white light. This is mostly noticeable during credit sequences and transitions betw
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQ0ODY1MzM4LDUzNzA4OTQyMCw3MTEyOT
E5MjZdfQ==
-->